...
parameters <- c(beta = 2.516, gamma = 0.291)
...
the graph express how it the dynamic of an infectious disease a long the time, in the begging of the infectious the number of susceptibles population is the highest, the more the infection increases , more the recovered increases, but more the recovereds increases more the  infection decreases 
